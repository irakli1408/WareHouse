...
namespace Jobs
{
    ...
    {
        private readonly static  WareHouseDataBaseEntities context = new WareHouseDataBaseEntities();
        ...
        GlobalConfiguration.Configuration
                ...
                .UseSqlServerStorage(@"server=DGA-086E1;database=WareHouseDataBase;Trusted_Connection=True;", new SqlServerStorageOptions
                {
           ...
           // var res = new JobProductRepository(context);

            Service sss = new Service();

            //if (DateTime.Now() == DateTimeForJobsAmountCounter.dateTime && DateTimeForJobsAmountCounter.CountDailyAmount < 30000)
            //{
                sss.method();
            //}
            //else if (DateTime.Now() != DateTimeForJobsAmountCounter.dateTime)
            //{
            //    context.DateTimeForJobsAmountCounter.Add(
            //    {
            ...
            //RecurringJob.AddOrUpdate("seconds", () => job.method(), "*/15 * * * * *");
